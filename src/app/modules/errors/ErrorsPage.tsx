...
const ErrorsPage = () => (
    <Routes>
        <Route element={<ErrorsLayout/>}>
            <Route path='403' element={<TemplateErrorPage title={"Access Denied"} code={403} message={"It appears that you are attempting to access content that you are not authorized to view. If you believe you should have access to this resource, please contacts the RDI team at MMPWW for assistance."}/>}/>
            ...
            <Route path='500' element={<TemplateErrorPage code={500} title={"Server Error"} message={"We're sorry, but an internal server error occurred while trying to fulfill your request. Please contacts the RDI team at MMPWW for assistance."}/>}/>
