...
const LanguageCreate: React.FC = () => {
    ...
    const handleCreate = (e: any) => {
        ...
        storeLanguage(form).then(response => {
                if (axios.isAxiosError(response)) {
                    ...
                    krysApp.setAlert({message: new AlertMessageGenerator('language', Actions.CREATE, KrysToastType.SUCCESS).message, type: KrysToastType.SUCCESS})
    ...
    return (
        <KTCard>
            ...
            <KTCardBody>
                ...
                <Formik initialValues={form} validationSchema={LanguageSchema} onSubmit={handleCreate} enableReinitialize>
                    {
                        () => (
