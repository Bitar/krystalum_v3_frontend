...
const OperatingSystemIndexFilter: React.FC<Props> = ({showFilter, setExportQuery}) => {
    ...
    return (
        <Collapse in={showFilter}>
            <Row id='#operating-systems-list-filter'>
                <Col>
...
export default OperatingSystemIndexFilter;