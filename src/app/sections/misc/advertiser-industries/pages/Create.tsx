...
const AdvertiserIndustryCreate: React.FC = () => {
    ...
    const handleCreate = (e: any) => {
        ...
        storeAdvertiserIndustry(form).then(response => {
                if (axios.isAxiosError(response)) {
                    ...
                    krysApp.setAlert({message: new AlertMessageGenerator('advertiser industry', Actions.CREATE, KrysToastType.SUCCESS).message, type: KrysToastType.SUCCESS});
    ...
    return (
        <KTCard>
            <KTCardHeader text="Create New Advertiser Industry" icon="fa-regular fa-plus" icon_style="fs-3 text-success"/>
