...
const AdvertiserIndustryIndexFilter: React.FC<Props> = ({showFilter, setExportQuery}) => {
    ...
    return (
        <Collapse in={showFilter}>
            <Row id='#advertiser-industries-list-filter'>
                <Col>
...
export default AdvertiserIndustryIndexFilter;