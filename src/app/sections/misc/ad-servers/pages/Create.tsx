...
import {defaultFormFields, FormFields, AdServerSchema} from '../core/form';
    ...
    const handleCreate = (e: any) => {
        ...
        storeAdServer(form).then(response => {
                if (axios.isAxiosError(response)) {
                    ...
                    krysApp.setAlert({message: new AlertMessageGenerator('ad server', Actions.CREATE, KrysToastType.SUCCESS).message, type: KrysToastType.SUCCESS});
