...
const CampaignRestrictionRequirementIndexFilter: React.FC<Props> = ({showFilter, setExportQuery}) => {
    ...
    return (
        <Collapse in={showFilter}>
            <Row id='#campaign-restriction-requirements-list-filter'>
                <Col>
...
export default CampaignRestrictionRequirementIndexFilter;