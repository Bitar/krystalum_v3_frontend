            ...
            <KTCardBody>
                {
                    form.type === PublicationRestrictionTypeEnum.META_RESTRICTIONS ?
                        <PublicationCampaignRestrictionMetaCreate/> : <PublicationCampaignRestrictionCreate
                            currentCampaignRestrictionTypeFormatted={currentCampaignRestrictionTypeFormatted}
                            filters={filters} refreshTable={refreshTable} setRefreshTable={setRefreshTable}/>
                }
            </KTCardBody>
        </KTCard>
    );
