...
const PublicationAdServersColumns: ReadonlyArray<Column<AdServer>> = [
  {
    Header: (props) => (
      <CustomHeader tableProps={props} title='Ad Server' className='min-w-125px' />
    ),
    id: 'ad-server',
      ...
      return (
        <Restricted to={'manage-supply'}>
          <ActionsCell
            ...
            text={`Are you sure you want to delete this publication ad server that has the ad server name '${
