...
import {FilterSchema} from '../../core/filterForm'
                  ...
                  <Row>
                    <Col md={4}>
                      ...
                      <DateRangePicker
                        ...
                        value={
                          filters.live_date_range
                            ? [
                                createDateFromString(filters.live_date_range.split(',')[0]),
                                createDateFromString(filters.live_date_range.split(',')[1]),
                              ]
                            : null
                        }
                      />
                    ...
                    <Col md={4}>
                      ...
                      <DateRangePicker
                        ...
                        value={
                          filters.creation_date_range
                            ? [
                                createDateFromString(filters.creation_date_range.split(',')[0]),
                                createDateFromString(filters.creation_date_range.split(',')[1]),
                              ]
                            : null
                        }
                      />
