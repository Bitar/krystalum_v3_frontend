              ...
              <div className='d-flex flex-column'>
                <div className='d-flex align-items-center mb-2'>
                  ...
                  {publication?.unique_identifier ? (
                    <BadgesCell
                      texts={[publication?.unique_identifier]}
                      color='light-info'
                      align='left'
                    />
                  ) : (
                ...
                <div className='d-flex flex-wrap fs-6 mb-4 pe-2'>
                  {publication?.publisher?.name && (
                    <OverlayTrigger placement='top' overlay={<Tooltip>Publisher</Tooltip>}>
                  ...
                  {publication?.info?.url && (
                    <OverlayTrigger placement='top' overlay={<Tooltip>Website URL</Tooltip>}>
                      <a
                  ...
                  {publication?.languages && (
                    <OverlayTrigger placement='top' overlay={<Tooltip>Languages</Tooltip>}>
                      <div className='d-flex align-items-center text-gray-400 me-5 mb-2'>
                        <KTSVG
                  ...
                  {publication?.live_date && (
                    <OverlayTrigger placement='top' overlay={<Tooltip>Live date</Tooltip>}>
                      <div className='d-flex align-items-center text-gray-400 me-5 mb-2'>
                        <KTSVG
                          path='/media/icons/duotune/general/gen014.svg'
                          className='svg-icon-4 me-1'
                        />
                        {formatDateToMonthDayYear(publication?.live_date)}
                      </div>
                    </OverlayTrigger>
                  )}

                  <OverlayTrigger placement='top' overlay={<Tooltip>Is Deal PMP?</Tooltip>}>
                    <div className='d-flex align-items-center text-gray-400 me-5 mb-2'>
                      <KTSVG
                      ...
                      {publication?.is_deal_pmp ? (
                        ...
                        <BadgesCell texts={['No']} color='light-danger' align='left' />
                      )}
                    </div>
                  </OverlayTrigger>
                </div>
            ...
            <div className='d-flex flex-wrap flex-stack'>
              <div className='d-flex flex-column flex-grow-1 pe-8'>
                <div className='d-flex flex-wrap'>
                  {(publication?.revenueType.id === RevenueTypeEnum.REVENUE_SHARE ||
                    (publication?.revenueType.id === RevenueTypeEnum.SAME_AS_PUBLISHER &&
                      publication?.publisher?.revenueType.id ===
                        RevenueTypeEnum.REVENUE_SHARE)) && (
                    <div className='border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3'>
                      <div className='d-flex align-items-center'>
                        ...
                        <div className='fs-5 fw-bold'>
                          {publication?.revenue_value
                            ? publication?.revenue_value
                            : publication?.publisher?.revenue_value}
                          %
                        </div>
                      </div>
                  ...
                  {(publication?.revenueType.id === RevenueTypeEnum.COMMITMENT ||
                    (publication?.revenueType.id === RevenueTypeEnum.SAME_AS_PUBLISHER &&
                      publication?.publisher?.revenueType.id === RevenueTypeEnum.COMMITMENT)) && (
                    <div className='border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3'>
                      <div className='d-flex align-items-center'>
                        <KTSVG
