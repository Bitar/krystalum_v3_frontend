...
import {Publication, PublicationList, PublicationPaginate} from '../../../models/supply/publication/Publication';
...
export const SHOW_INCLUDES = 'include[]=info&include[]=languages&include[]=formats&include[]=verticals&include[]=adServers';
...
export const storePublication = async (publication: any): Promise<Publication | AxiosError | undefined> => {
...
export const updatePublication = async (id: number, publication: any): Promise<Publication | AxiosError | undefined> => {
    let formData = createFormData(publication);
