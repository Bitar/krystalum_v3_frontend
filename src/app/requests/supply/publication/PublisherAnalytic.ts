...
export const getPublicationAnalytics = (
  ...
  query?: String
): Promise<PublicationAnalyticPaginate> => {
  ...
  return axios
    .get(url)
    .then((response: AxiosResponse<PublicationAnalyticPaginate>) => response.data)
    .catch((error) => {
      return error
    })
}

export const getPublicationAnalytic = async (
  publication: Publication,
  id: number
): Promise<PublicationAnalytic | AxiosError | undefined> => {
...
export const storePublicationAnalytic = async (
  publication: Publication,
  form: any
): Promise<PublicationAnalytic | AxiosError | undefined> => {
  let url = `${ENDPOINT}/${publication.id}/${ENDPOINT_ADDITION}`
...
export const updatePublicationAnalytic = async (
  publication: Publication,
  id: number,
  publicationAnalytic: any
): Promise<PublicationAnalytic | AxiosError | undefined> => {
  let url = `${ENDPOINT}/${publication.id}/${ENDPOINT_ADDITION}`
